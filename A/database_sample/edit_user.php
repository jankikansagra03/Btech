    ...
    ?>
        <form id="reg" action="update_user_data.php" method="post" enctype="multipart/form-data">
            ...
            <table align="center" style="border: 1px solid black;background-color:#ebf0f0; padding: 30px;" width="50%">
                ...
                <tr>
                    <td><input type="text" name="fn" id="fn1" placeholder="Ex. Janki Kansagra" value="<?php echo $a[0]; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input type="checkbox" name="hobbies[]" value="Watching Movies" <?php
                                                                                        if (in_array("Watching Movies", $h)) {
                                                                                            echo "checked";
                                                                                        }
                                                                                        ?>>Watching Movies
                        <input type="checkbox" name="hobbies[]" value="Reading Books" <?php
                                                                                        if (in_array("Reading Books", $h)) {
                                                                                            echo "checked";
                                                                                        }
                                                                                        ?>>Reading Books
                        <input type="checkbox" name="hobbies[]" value="Cooking" <?php
                                                                                if (in_array("Cooking", $h)) {
                                                                                    echo "checked";
                                                                                }
                                                                                ?>>Cooking
                        <input type="checkbox" name="hobbies[]" value="Palying Sports" <?php
                                                                                        if (in_array("Palying Sports", $h)) {
                                                                                            echo "checked";
                                                                                        }
                                                                                        ?>>Playing Sports
                    </td>
                ...
                <tr>
                    <td><img src="profile_pictures/<?php echo $a[8]; ?>" alt=""></td>
                </tr>
                <tr>
